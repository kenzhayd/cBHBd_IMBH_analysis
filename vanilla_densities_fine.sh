...
# Array range matches vanilla_densities_fine.csv (500 tasks). Do not edit by hand.
#SBATCH --account=def-vhenault
#SBATCH --job-name=vanilla_densities_fine
...
python single_model.py --task_id $SLURM_ARRAY_TASK_ID --jobs_file vanilla_densities_fine.csv --output_dir output
