...
# Array range matches densities_course.csv (300 tasks). Do not edit by hand.
#SBATCH --account=def-vhenault
#SBATCH --job-name=densities_course
...
python single_model.py --task_id $SLURM_ARRAY_TASK_ID --jobs_file densities_course.csv --output_dir output
