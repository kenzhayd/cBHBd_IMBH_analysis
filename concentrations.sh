...
# Array range matches concentrations.csv (1000 tasks). Do not edit by hand.
#SBATCH --account=def-vhenault
#SBATCH --job-name=concentrations
...
python single_model.py --task_id $SLURM_ARRAY_TASK_ID --jobs_file concentrations.csv --output_dir output
