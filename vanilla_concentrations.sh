...
# Array range matches vanilla_concentrations.csv (1000 tasks). Do not edit by hand.
#SBATCH --account=def-vhenault
#SBATCH --job-name=vanilla_concentrations
...
python single_model.py --task_id $SLURM_ARRAY_TASK_ID --jobs_file vanilla_concentrations.csv --output_dir output
